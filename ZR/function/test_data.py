...
"'+nowtime+'",62222519,15000,"备注备注备注","'+nowtime+'","报案人姓名小天","110112113114",1,500.00,"'+nowtime+'")'
        #----测试理赔确认接口 状态改为4
...
"'+nowtime+'",62222519,15000,"备注备注备注","'+nowtime+'","报案人姓名小天","110112113114",4,500.00,"'+nowtime+'")'
...
AUXILIARY='INSERT into zr_case_auxiliary VALUES(9,"'+nowtime+'","天府大道199号4号楼","YZ-101",9,"'+nowtime+'")'
AUXILIARY1='DELETE from zr_case_auxiliary where id=9'

#自如备份表
ZR_CASE_FLOW="DELETE from zr_case_flow where zr_flowing_no=110112113114"
...
#
# a='INSERT into case_form VALUES("40","'+nowtime+'","福666%%",206600.00,"jts0oe7silrxv3upx5",15000,\
# "xx@qq.com","民",13466666666,"2018-02-12 14:14:19",150002,"山784677689号楼","AMC5989698546555",1,1,1,"9886665965665","'+nowtime+'",\
# "'+nowtime+'",4352219865665,15000,"备注备注备注","'+nowtime+'","测","110156483114",1,800.00,"'+nowtime+'")'
# sql(config_file_path, a, database_name)  # 案件信息表插入数据
